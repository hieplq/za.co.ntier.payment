...
/** Generated Interface for ZZ_BankCode
 *  @author iDempiere (generated) 
 *  @version Release 12
 */
@SuppressWarnings("all")
public interface I_ZZ_BankCode 
{
    ...
    /** Column name ZZ_BankCode_ID */
    public static final String COLUMNNAME_ZZ_BankCode_ID = "ZZ_BankCode_ID";

	/** Set Bank Code.
	  * Add extra info to bank account for generate ETF
	  */
    ...
    /** Column name ZZ_BankCode_UU */
    public static final String COLUMNNAME_ZZ_BankCode_UU = "ZZ_BankCode_UU";
